<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
    ...
    <link rel="stylesheet" href="css/swiper.min.css?v=201805121244">
    <link rel="stylesheet" href="css/floorDetail.css?v=201805121244">
    ...
    <li class="preferential active"><a href="#preferential">优惠活动</a></li>
    ...
    <script type="text/javascript" src="js/swiper.min.js?v=201805121244"></script>
    <script type="text/javascript" src="http://api.map.baidu.com/api?
    v=3.0&ak=CB2ede775afeb6e413abd40261396a69"></script>
    <script type="text/javascript" src="js/floorDetail.js?v=201805121244"></script>
    </body>
    </html>